			...
			<div class="_gaps_m znqjceqz">
				...
				<FormSection>
					...
					<div :class="$style.contributors">
						...
						<a href="https://github.com/srnovus" target="_blank" :class="$style.contributor">
							<img src="https://avatars.githubusercontent.com/u/81489497" :class="$style.contributorAvatar">
